                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-slate-700">
                        <thead class="bg-gray-50 dark:bg-slate-900">
                            <tr>
                                <th class="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider dark:text-gray-400 sticky left-0 bg-gray-50 dark:bg-slate-900 z-20 cursor-pointer hover:bg-gray-100 dark:hover:bg-slate-800" @click="handleSort('nik')">
                                    <div class="flex items-center gap-1">
                                        NIK
                                        <span v-if="sort === 'nik'" class="text-indigo-600 dark:text-indigo-400">{{ getSortIcon('nik') }}</span>
                                    </div>
                                </th>
                                <th class="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider dark:text-gray-400 sticky left-20 bg-gray-50 dark:bg-slate-900 z-10 cursor-pointer hover:bg-gray-100 dark:hover:bg-slate-800" @click="handleSort('nama')">
                                    <div class="flex items-center gap-1">
                                        Nama
                                        <span v-if="sort === 'nama'" class="text-indigo-600 dark:text-indigo-400">{{ getSortIcon('nama') }}</span>
                                    </div>
                                </th>
                                <th class="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider dark:text-gray-400 cursor-pointer hover:bg-gray-100 dark:hover:bg-slate-800" @click="handleSort('gender')">
                                    <div class="flex items-center gap-1">
                                        Gender
                                        <span v-if="sort === 'gender'" class="text-indigo-600 dark:text-indigo-400">{{ getSortIcon('gender') }}</span>
                                    </div>
                                </th>
                                <th class="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider dark:text-gray-400 cursor-pointer hover:bg-gray-100 dark:hover:bg-slate-800" @click="handleSort('tanggal_lahir')">
                                    <div class="flex items-center gap-1">
                                        Tgl Lahir
                                        <span v-if="sort === 'tanggal_lahir'" class="text-indigo-600 dark:text-indigo-400">{{ getSortIcon('tanggal_lahir') }}</span>
                                    </div>
                                </th>
