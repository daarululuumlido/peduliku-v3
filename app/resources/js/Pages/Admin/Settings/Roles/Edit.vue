    ...
    <ModuleLayout>
        ...
        <div class="py-12">
            <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                <!-- Super Admin Warning -->
                <div v-if="isSuperAdmin" class="mb-4 p-4 bg-yellow-100 border border-yellow-400 text-yellow-700 rounded">
                    ⚠️ Role Super Admin memiliki semua permission secara otomatis dan tidak perlu dikonfigurasi.
                </div>
