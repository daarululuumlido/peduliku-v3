...
const form = useForm({
    ...
    is_pimpinan: Boolean(props.jabatan.is_pimpinan),
    kuota_sdm: props.jabatan.kuota_sdm,
    keterangan: props.jabatan.keterangan || '',
});

const submit = () => {
    form.put(route('hris.unit-organisasi.master-jabatan.update', [props.unit.id, props.jabatan.id]));
};
</script>
