...
const submit = () => {
    form.post(route('hris.unit-organisasi.store'));
};
</script>
    ...
    <ModuleLayout>
        <template #header>
            <div class="flex items-center gap-4">
                <Link
                    :href="route('hris.unit-organisasi.index')"
                    ...
                    <form @submit.prevent="submit" class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                :class="{ 'border-red-500': form.errors.struktur_id }"
                            >
                            ...
                            <p v-if="form.errors.struktur_id" class="mt-1 text-sm text-red-600">
                                {{ form.errors.struktur_id }}
                            </p>
                        </div>
