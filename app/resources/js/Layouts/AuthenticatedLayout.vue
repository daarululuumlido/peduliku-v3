                        ...
                        <div class="flex">
                            ...
                            >
                                ...
                                <NavLink
                                    ...
                                    :active="route().current('orang.*')"
                                >
                                    Data Orang
                                </NavLink>
                                <NavLink
                                    :href="route('admin.kartu-keluarga.index')"
                                    :active="route().current('kartu-keluarga.*')"
                                >
                                    Kartu Keluarga
                                </NavLink>
                                    ...
                                    <Dropdown align="left" width="48">
                                        <template #trigger>
                                            <button
                                                ...
                                                :class="{
                                                    'border-b-2 border-indigo-400 text-gray-900': route().current('settings.*'),
                                                    'border-b-2 border-transparent': !route().current('settings.*')
                                                }"
                                            >
                                                Settings
                                        ...
                                        <template #content>
                                            <DropdownLink :href="route('admin.settings.users.index')">
                                                Manajemen User
                                            </DropdownLink>
                                            <DropdownLink :href="route('admin.settings.roles.index')">
                                                Manajemen Role
                                            </DropdownLink>
                                            <DropdownLink :href="route('admin.settings.permissions.index')">
                ...
                >
                    <div class="space-y-1 pb-3 pt-2">
                        ...
                        <div class="border-t border-gray-200 mt-2 pt-2">
                            <div class="px-4 py-1 text-xs font-semibold text-gray-400 uppercase">
                                Settings
                            </div>
                            <ResponsiveNavLink
